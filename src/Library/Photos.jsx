...
const photoList = [
  ...
  return (
    <div className="bg-white min-h-screen text-blue-700 ">
      <Header />
        <div className="ml-30 mb-12">
          <h1 className="text-4xl font-bold text-blue-600">រូបភាពអនុស្សាវរីយ៍</h1>
          ...
          {photoList.map((photo) => (
            ...
            >
              ...
              <div className="p-4 text-center">
                <h3 className="text-lg font-semibold text-blue-800 mb-1">{photo.title}</h3>
